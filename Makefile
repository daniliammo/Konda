...
STDLIB_ИСХ = stdlib/файл.конда stdlib/строки.конда stdlib/хеш.конда stdlib/поток.конда stdlib/версия.конда stdlib/срезы.конда
...
ФРОНТЕНД_ИСХ = сборка/сборка.конда сборка/сборка_шим.h toml/toml.конда
